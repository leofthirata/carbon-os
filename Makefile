FILES = ./build/kernel.asm.o ./build/kernel.o ./build/gdt/gdt.asm.o ./build/gdt/gdt.o ./build/fs/fat/fat16.o ./build/fs/file.o ./build/string/string.o ./build/disk/streamer.o ./build/fs/pparser.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/disk/disk.o
INCLUDES = -I ./src
...
# since 100 sectors of nulls are defined, 
# bs must be changed to 1048576 (0x100000)
# and count to 16 -> 16MB of nulls
# linux will use this space to store our data files
